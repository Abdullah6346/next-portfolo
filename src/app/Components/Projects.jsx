        ...
        {projectDetails.map((detail, i) => (
          ...
          >
            ...
            <div className="cont-article p-4 py-5">
              ...
              <h3 className="pt-5 font-bold text-[#CCCCCC]">
                Tech Stack:{" "}
                <span className="font-light">{detail.techstack}</span>
              </h3>
              <div className="cont-links flex items-center justify-between pt-4 text-[#CCCCCC]">
                <div className="inner-links flex items-center gap-2">
                  <svg
